...
<!--表单填写部分    -->
          <el-main>
            ...
            <input type="button" @click="signup" value="注册"  class="signup" style="color: black">
  ...
  export default {
    ...
    methods:{
      change(data){     //组件之间传值
        ...
        submitForm(formName) {
          sessionStorage.setItem('user_name',this.ruleForm2.username)
